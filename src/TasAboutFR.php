...
class TasAboutFR extends TasAbout
{
    ...
    protected function menu(): void
    {
        ...
        $this->subList('- Définition', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        $this->SetLink($link, 0, '*7');
        $this->subList('- Catégorie', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        $this->SetLink($link, 0, '*9');
        $this->subList('- Chronomètre', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        $this->SetLink($link, 0, '*11');
        $this->subList('- Émulateur BizHawk', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        $this->SetLink($link, 0, '*13');
        $this->list('- Annexes', $y, self::X_LEFT, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        $this->SetLink($link, 0, '*14');
        $this->subList('- Vocabulaire', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        ...
        $this->subList('- Ressources', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        $this->SetLink($link, 0, '*20');
        $this->subList('- Évènements', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        $this->SetLink($link, 0, '*22');
        $this->subList('- Autres types de Tool-Assisted', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        ...
        $this->list('- Techniques', $y, self::X_RIGHT, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        ...
        $this->subList('- Langue du jeu', $y, self::X_RIGHT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        ...
        $this->subList('- Réduction des lags', $y, self::X_RIGHT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
        ...
        $this->subList('- Manipulation de la chance', $y, self::X_RIGHT + self::X_SPACE_FOR_SUB_LIST, $link);
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $link = $this->AddLink();
