...
class TasAboutEN extends TasAbout
{
    ...
    protected function menu(): void
    {
        ...
        $this->subList('- Definition', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(5));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Category', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(7));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Timer', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(9));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- BizHawk emulator', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(11));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->list('- Appendices', $y, self::X_LEFT, $this->setupLink(13));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Vocabulary', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(14));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- LiveSplit', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(16));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Resources', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(18));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Events', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(20));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Other kind of Tool-Assisted', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(22));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Miscellaneous', $y, self::X_LEFT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(24));

        // Right

        $y = self::Y_TITLE + self::Y_SPACE_BETWEEN_TITLE_AND_SUB_TITLE;
        $this->list('- Skills', $y, self::X_RIGHT, $this->setupLink(26));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Glitch / Glitch Hunting', $y, self::X_RIGHT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(28));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Language of the game', $y, self::X_RIGHT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(30));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        ...
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Lag reduction', $y, self::X_RIGHT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(36));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        ...
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
        $this->subList('- Luck manipulation', $y, self::X_RIGHT + self::X_SPACE_FOR_SUB_LIST, $this->setupLink(48));
        $y += self::Y_SPACE_BETWEEN_LIST_ELEMENTS;
