...
- 🇺🇸 Développeurs speedrunnant leur propre jeu (<Link hrefId="links_polyphonyLunarRun" content="Polyphony Lunar Run" /> - <Link hrefId="links_proGymnast" content="Pro Gymnast" />)
...
- ... joueurs (<Link hrefId="ta_tasMultiPlayers2" content="2" />, <Link hrefId="ta_tasMultiPlayers3" content="3" />, <Link hrefId="ta_tasMultiPlayers4" content="4" />)
...
Afin d'être sûr de pouvoir effectuer le meilleur temps sur un jeu, il faut s'assurer de jouer avec la version localisée du jeu <Link hrefId="language_advantages" content="présentant des avantages" />.
